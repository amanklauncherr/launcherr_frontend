...
const FlightInfo = ({ currency, numberOfBookableSeats, arrival_Date, departure_Date, carrierCode, departure_at, departure_iataCode, arrival_at, arrival_iataCode, duration, Price_grandTotal }) => {
