        ...
        <div className="cart-list-inner">
          <form action="#">
            <div className="table-responsive">
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td className="">
                      ...
                      <span className="cartImage"><img src="assets/images/product1.jpg" alt="image" /></span>
                    </td>
                    <td data-column="Product Name">Sleeping bag</td>
                    <td data-column="Price">₹ 99.00</td>
                    <td data-column="Quantity" className="count-input">
                      <div>
                        <input type="number" name="" id="" />
                      </div>
                    </td>
                    <td data-column="Sub Total">₹ 99.00</td>
                  </tr>
                </tbody>
                <tbody>
                  <tr>
                    ...
                    <td data-column="Product Name">Jacket</td>
                    <td data-column="Price">₹ 99.00</td>
                    <td data-column="Quantity" className="count-input">
                      <div>
                        <input type="number" name="" id="" />
                ...
                <tbody><tr>
                  ...
                  <td data-column="Product Name">Hammock</td>
                  <td data-column="Price">₹ 99.00</td>
                  <td data-column="Quantity" className="count-input">
                    <div>
                      <input type="number" name="" id="" />
            ...
            <div className="updateArea">
              ...
              <a href="#" className="book-btn-primary">update cart</a>
            </div>
